...
| Module | Document Title | Description |
| :--- | :--- | :--- |
| **M1.3.1** | [**Product Information (PI)**](https://github.com/gsopas/PZL/blob/main/dossier/M1_Administrative/M1.3.1_PRODUCT_INFORMATION_PZL_DEPOT.pdf) | Clinical guidance for Narrow Therapeutic Index (NTI) switching. |
